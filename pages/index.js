...
const Home = () => {
  return (
    <>
      <Head>
        <link rel="stylesheet" href="/css/index/app.css"></link>
                      ...
                      <div className="text text-container">
                        ...
                        <div className="text text-details">
                          <p className="text text-description">
                            ...
                            elit. Ea nulla cum impedit et nemo molestiae,
                            suscipit animi officiis soluta natus, provident ab
                            laudantium, amet dolorum.
                          </p>
                          <a
                            href="#"
                    ...
                    <div className="card-text">
                      <div className="text text-container">
                        <div className="text text-header">
                          ...
                          <p className="text text-subtitle">Release momentum</p>
                        </div>
                        <div className="text text-details">
                          <p className="text text-description">
                            Lorem ipsum dolor sit amet, consectetur adipisicing
