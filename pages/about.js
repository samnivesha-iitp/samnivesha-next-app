            ...
            <div className="row h-100 align-items-center py-5">
              <div className="col-lg-6">
                ...
                <p className="lead text-muted" id="1">
                  ...
                  engineering. Students from colleges across Bihar participated
                  with great zeal and enthusiasm. The total footfall is
                  estimated to be around 2000! Prof Devdas Menon (IIT Madras)
                  gave a very informative guest lecture. Several events like
                  Richter 9.0 related to earthquake resistibility, BluePrint to
                  showcase your designing skills, CiviQ to test your knowledge
                  in this field, House of cards attracted huge participation
                  from various colleges of Bihar. A workshop on STAAD PRO,
                  software widely used in structural engineering was also
                  ...
                  the purpose of producing better engineers for a better
                  tomorrow.
                </p>
              </div>
